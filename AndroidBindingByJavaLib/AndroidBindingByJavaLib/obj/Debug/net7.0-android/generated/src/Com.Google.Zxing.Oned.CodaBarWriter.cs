...
namespace Com.Google.Zxing.Oned {
	...
	public sealed partial class CodaBarWriter : global::Com.Google.Zxing.Oned.OneDimensionalCodeWriter {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/oned/CodaBarWriter", typeof (CodaBarWriter));
		...
		[Register (".ctor", "()V", "")]
		public unsafe CodaBarWriter () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
