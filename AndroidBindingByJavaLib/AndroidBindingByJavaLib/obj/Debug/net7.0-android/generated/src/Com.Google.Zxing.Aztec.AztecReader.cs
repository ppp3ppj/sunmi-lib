...
namespace Com.Google.Zxing.Aztec {
	...
	public sealed partial class AztecReader : global::Java.Lang.Object, global::Com.Google.Zxing.IReader {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/aztec/AztecReader", typeof (AztecReader));
		...
		[Register (".ctor", "()V", "")]
		public unsafe AztecReader () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
