...
namespace Com.Google.Zxing.Oned {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.google.zxing.oned']/class[@name='UPCAWriter']"
	[global::Android.Runtime.Register ("com/google/zxing/oned/UPCAWriter", DoNotGenerateAcw=true)]
	public sealed partial class UPCAWriter : global::Java.Lang.Object, global::Com.Google.Zxing.IWriter {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/oned/UPCAWriter", typeof (UPCAWriter));
		...
		internal UPCAWriter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.google.zxing.oned']/class[@name='UPCAWriter']/constructor[@name='UPCAWriter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe UPCAWriter () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.zxing.oned']/class[@name='UPCAWriter']/method[@name='encode' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.google.zxing.BarcodeFormat'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.zxing.oned']/class[@name='UPCAWriter']/method[@name='encode' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.google.zxing.BarcodeFormat'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='java.util.Map&lt;com.google.zxing.EncodeHintType, ?&gt;']]"
