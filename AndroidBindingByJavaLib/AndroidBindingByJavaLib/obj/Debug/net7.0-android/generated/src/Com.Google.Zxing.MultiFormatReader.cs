...
namespace Com.Google.Zxing {
	...
	public sealed partial class MultiFormatReader : global::Java.Lang.Object, global::Com.Google.Zxing.IReader {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/MultiFormatReader", typeof (MultiFormatReader));
		...
		[Register (".ctor", "()V", "")]
		public unsafe MultiFormatReader () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		public unsafe global::Com.Google.Zxing.Result? DecodeWithState (global::Com.Google.Zxing.BinaryBitmap? image)
		{
			const string __id = "decodeWithState.(Lcom/google/zxing/BinaryBitmap;)Lcom/google/zxing/Result;";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((image == null) ? IntPtr.Zero : ((global::Java.Lang.Object) image).Handle);
				var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, __args);
		...
		public unsafe void SetHints (global::System.Collections.Generic.IDictionary<global::Com.Google.Zxing.DecodeHintType, object>? hints)
		{
			const string __id = "setHints.(Ljava/util/Map;)V";
			IntPtr native_hints = global::Android.Runtime.JavaDictionary<global::Com.Google.Zxing.DecodeHintType, object>.ToLocalJniHandle (hints);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
