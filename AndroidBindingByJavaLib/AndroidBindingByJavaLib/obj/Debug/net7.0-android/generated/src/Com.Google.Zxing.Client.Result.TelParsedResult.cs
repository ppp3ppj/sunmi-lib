...
namespace Com.Google.Zxing.Client.Result {
	...
	public sealed partial class TelParsedResult : global::Com.Google.Zxing.Client.Result.ParsedResult {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/client/result/TelParsedResult", typeof (TelParsedResult));
		...
		public unsafe TelParsedResult (string? number, string? telURI, string? title) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				JNIEnv.DeleteLocalRef (native_telURI);
		...
		public unsafe string? TelURI {
			...
			[Register ("getTelURI", "()Ljava/lang/String;", "")]
			get {
				const string __id = "getTelURI.()Ljava/lang/String;";
				try {
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
					return JNIEnv.GetString (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
