...
namespace Com.Google.Zxing.Datamatrix {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.google.zxing.datamatrix']/class[@name='DataMatrixWriter']"
	[global::Android.Runtime.Register ("com/google/zxing/datamatrix/DataMatrixWriter", DoNotGenerateAcw=true)]
	public sealed partial class DataMatrixWriter : global::Java.Lang.Object, global::Com.Google.Zxing.IWriter {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/datamatrix/DataMatrixWriter", typeof (DataMatrixWriter));
		...
		internal DataMatrixWriter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.google.zxing.datamatrix']/class[@name='DataMatrixWriter']/constructor[@name='DataMatrixWriter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe DataMatrixWriter () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.zxing.datamatrix']/class[@name='DataMatrixWriter']/method[@name='encode' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.google.zxing.BarcodeFormat'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
