...
namespace Com.Google.Zxing.Aztec {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.google.zxing.aztec']/class[@name='AztecWriter']"
	[global::Android.Runtime.Register ("com/google/zxing/aztec/AztecWriter", DoNotGenerateAcw=true)]
	public sealed partial class AztecWriter : global::Java.Lang.Object, global::Com.Google.Zxing.IWriter {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/aztec/AztecWriter", typeof (AztecWriter));
		...
		internal AztecWriter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.google.zxing.aztec']/class[@name='AztecWriter']/constructor[@name='AztecWriter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AztecWriter () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.zxing.aztec']/class[@name='AztecWriter']/method[@name='encode' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.google.zxing.BarcodeFormat'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.google.zxing.aztec']/class[@name='AztecWriter']/method[@name='encode' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='com.google.zxing.BarcodeFormat'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='java.util.Map&lt;com.google.zxing.EncodeHintType, ?&gt;']]"
