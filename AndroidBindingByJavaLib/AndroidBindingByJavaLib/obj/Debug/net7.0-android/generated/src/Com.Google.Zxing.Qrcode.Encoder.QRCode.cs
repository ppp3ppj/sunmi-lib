...
namespace Com.Google.Zxing.Qrcode.Encoder {
	...
	public sealed partial class QRCode : global::Java.Lang.Object {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/qrcode/encoder/QRCode", typeof (QRCode));
		...
		[Register (".ctor", "()V", "")]
		public unsafe QRCode () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		public unsafe global::Com.Google.Zxing.Qrcode.Decoder.ErrorCorrectionLevel? ECLevel {
			...
			[Register ("getECLevel", "()Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;", "")]
			get {
				const string __id = "getECLevel.()Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;";
				try {
			...
			[Register ("setECLevel", "(Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;)V", "")]
			set {
				const string __id = "setECLevel.(Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;)V";
				try {
		...
		public unsafe int MaskPattern {
			...
			[Register ("getMaskPattern", "()I", "")]
			get {
				const string __id = "getMaskPattern.()I";
				try {
			...
			[Register ("setMaskPattern", "(I)V", "")]
			set {
				const string __id = "setMaskPattern.(I)V";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
		...
		public unsafe global::Com.Google.Zxing.Qrcode.Encoder.ByteMatrix? Matrix {
			...
			[Register ("getMatrix", "()Lcom/google/zxing/qrcode/encoder/ByteMatrix;", "")]
			get {
				const string __id = "getMatrix.()Lcom/google/zxing/qrcode/encoder/ByteMatrix;";
				try {
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
					return global::Java.Lang.Object.GetObject<global::Com.Google.Zxing.Qrcode.Encoder.ByteMatrix> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
			...
			[Register ("setMatrix", "(Lcom/google/zxing/qrcode/encoder/ByteMatrix;)V", "")]
			set {
				const string __id = "setMatrix.(Lcom/google/zxing/qrcode/encoder/ByteMatrix;)V";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue ((value == null) ? IntPtr.Zero : ((global::Java.Lang.Object) value).Handle);
					_members.InstanceMethods.InvokeAbstractVoidMethod (__id, this, __args);
		...
		public unsafe global::Com.Google.Zxing.Qrcode.Decoder.Mode? Mode {
			...
			[Register ("getMode", "()Lcom/google/zxing/qrcode/decoder/Mode;", "")]
			get {
				const string __id = "getMode.()Lcom/google/zxing/qrcode/decoder/Mode;";
				try {
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
			...
			[Register ("setMode", "(Lcom/google/zxing/qrcode/decoder/Mode;)V", "")]
			set {
				const string __id = "setMode.(Lcom/google/zxing/qrcode/decoder/Mode;)V";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue ((value == null) ? IntPtr.Zero : ((global::Java.Lang.Object) value).Handle);
					_members.InstanceMethods.InvokeAbstractVoidMethod (__id, this, __args);
		...
		public unsafe global::Com.Google.Zxing.Qrcode.Decoder.Version? Version {
			...
			[Register ("getVersion", "()Lcom/google/zxing/qrcode/decoder/Version;", "")]
			get {
				const string __id = "getVersion.()Lcom/google/zxing/qrcode/decoder/Version;";
				try {
					var __rm = _members.InstanceMethods.InvokeAbstractObjectMethod (__id, this, null);
			...
			[Register ("setVersion", "(Lcom/google/zxing/qrcode/decoder/Version;)V", "")]
			set {
				const string __id = "setVersion.(Lcom/google/zxing/qrcode/decoder/Version;)V";
				try {
					JniArgumentValue* __args = stackalloc JniArgumentValue [1];
					__args [0] = new JniArgumentValue ((value == null) ? IntPtr.Zero : ((global::Java.Lang.Object) value).Handle);
					_members.InstanceMethods.InvokeAbstractVoidMethod (__id, this, __args);
		...
		public static unsafe bool IsValidMaskPattern (int maskPattern)
		{
			const string __id = "isValidMaskPattern.(I)Z";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue (maskPattern);
