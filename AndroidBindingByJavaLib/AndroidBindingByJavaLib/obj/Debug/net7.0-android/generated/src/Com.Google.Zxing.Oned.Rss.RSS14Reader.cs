...
namespace Com.Google.Zxing.Oned.Rss {
	...
	public sealed partial class RSS14Reader : global::Com.Google.Zxing.Oned.Rss.AbstractRSSReader {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/oned/rss/RSS14Reader", typeof (RSS14Reader));
		...
		[Register (".ctor", "()V", "")]
		public unsafe RSS14Reader () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
