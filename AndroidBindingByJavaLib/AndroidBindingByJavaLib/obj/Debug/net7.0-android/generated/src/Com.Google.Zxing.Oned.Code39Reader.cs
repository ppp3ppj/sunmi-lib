...
namespace Com.Google.Zxing.Oned {
	...
	public sealed partial class Code39Reader : global::Com.Google.Zxing.Oned.OneDReader {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/google/zxing/oned/Code39Reader", typeof (Code39Reader));
		...
		[Register (".ctor", "()V", "")]
		public unsafe Code39Reader () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		[Register (".ctor", "(Z)V", "")]
		public unsafe Code39Reader (bool usingCheckDigit) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JniArgumentValue (usingCheckDigit);
		...
		[Register (".ctor", "(ZZ)V", "")]
		public unsafe Code39Reader (bool usingCheckDigit, bool extendedMode) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [0] = new JniArgumentValue (usingCheckDigit);
				__args [1] = new JniArgumentValue (extendedMode);
				var __r = _members.InstanceMethods.StartCreateInstance (__id, ((object) this).GetType (), __args);
				SetHandle (__r.Handle, JniHandleOwnership.TransferLocalRef);
				_members.InstanceMethods.FinishCreateInstance (__id, this, __args);
			} finally {
