package com.ppp.sunmit2printer.utils;
...
//import com.ppp.sunmit2printer.R;
//import com.sunmi.library.R;
import com.ppp.sunmit2printer.R;
...
public class SunmiPrintHelper {
    ...
    public void printBitmapBase64(String base64String, int orientation) {
        ...
        byte[] decodedString = Base64.decode(base64Image, 0);
        Bitmap bitmapData = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
        try {
            if(orientation == 0) {
                sunmiPrinterService.printBitmap(bitmapData, null);
            }
            else {
                sunmiPrinterService.printBitmap(bitmapData, null);
            }
    ...
    public void printBitmapCustomGrayScaleBase64(String base64String, int orientation) {
        String base64Image = base64String.split(",")[1];
        byte[] decodedString = Base64.decode(base64Image, 0);
        Bitmap bitmapData = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
        if(sunmiPrinterService == null){
        ...
        try {
            if(orientation == 0) {
                sunmiPrinterService.printBitmapCustom(bitmapData, 2, null);
            }
            else {
                sunmiPrinterService.printBitmapCustom(bitmapData, 2, null);
            }
   ...
   /*
    public void printExample(Context context){
        ...
        try {
            ...
            //Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.string.app_name);
            //Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.icons_);
            sunmiPrinterService.printBitmap(bitmap, null);
    ...
    */
    ...
    public void sunmiPrintColumnsString(String dataText[],int width[], int align[]) {
        if(sunmiPrinterService == null){
            return;
        }
        try {
            sunmiPrinterService.printColumnsString(dataText, width, align, null );
        }catch (RemoteException e) {
            e.printStackTrace();
        }
    }

    public void sunmiLineWrap(int n) {
        if(sunmiPrinterService == null){
            return;
        }
        try {
    ...
    public void printExampleWithBitMap(Context context, Bitmap bitmap){
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return ;
        }
